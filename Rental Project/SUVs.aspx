<%@ Page Title="SUVs" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="SUVs.aspx.cs" Inherits="SUVs" %>
...
<ControlStyle Height="150px" Width="200px"></ControlStyle>
      ...
      <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" DeleteMethod="Delete" InsertMethod="Insert" OldValuesParameterFormatString="original_{0}" SelectMethod="GetDataBySUV" TypeName="DataSet1TableAdapters.InventoryTableAdapter" UpdateMethod="Update">
          <DeleteParameters>
