<%@ Page Title="Coupes" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Coupes2.aspx.cs" Inherits="Coupes2" %>
...
<ControlStyle Height="150px" Width="200px"></ControlStyle>
            ...
            <asp:CommandField InsertText="Add to Cart" ShowSelectButton="True" SelectText="Add to Cart" />
        </Columns>
    </asp:GridView>

    <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" DeleteMethod="Delete" InsertMethod="Insert" OldValuesParameterFormatString="original_{0}" SelectMethod="GetDataByCoupe" TypeName="DataSet1TableAdapters.InventoryTableAdapter" UpdateMethod="Update">
        <DeleteParameters>
